...
class Game
    ...
    def win?
        if Board.get_board_value(0, 0) == Board.get_board_value(0, 2) && Board.get_board_value(0, 0) == Board.get_board_value(0, 4) then
            ...
            true
        elsif Board.get_board_value(0, 0) == Board.get_board_value(2, 0) && Board.get_board_value(0, 0) == Board.get_board_value(4, 0) then
            true
        elsif Board.get_board_value(0, 2) == Board.get_board_value(2, 2) && Board.get_board_value(0, 2) == Board.get_board_value(4, 2) then
            true
        elsif Board.get_board_value(0, 4) == Board.get_board_value(2, 4) && Board.get_board_value(0, 4) == Board.get_board_value(4, 4) then 
            true
        elsif Board.get_board_value(0, 0) == Board.get_board_value(2, 2) && Board.get_board_value(0, 0) == Board.get_board_value(4, 4) then
            true
        elsif Board.get_board_value(0, 4) == Board.get_board_value(2, 2) && Board.get_board_value(0, 4) == Board.get_board_value(4, 0) then
            true
        else
            false
        end
